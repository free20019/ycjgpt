...
public class JacksonUtil {
	...
	* list中key值转为大写
	* */
	public static  List<Map<String, Object>> getUpperCaseList(List<Map<String, Object>> baseList) {
		Map<String, Object> map;
		List<Map<String, Object>> list = new ArrayList<>();
		if(baseList==null||baseList.size()==0){
			return baseList;
		}else{
			for (Map<String, Object> baseMap:baseList     //遍历list
			) {
				map = new HashMap<>();
				for (Map.Entry<String,Object>  entry:baseMap.entrySet()   //遍历map的key集合 获取对应key的value
				) {
